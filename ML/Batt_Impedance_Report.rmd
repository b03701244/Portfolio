...
```{r head, echo = F, include = T, message=F}
head(dat)
```

## Summary of data:
```{r summary, echo = F, include = T, message=F}
summary(dat)
```

## Plot of data:

```{r plot, echo=F, include =T, message=F}
dat.plot <- test_set %>%
...
```{r knn, echo = T, include = T, message=F}
...
2. GLM
```{r glm, echo = T, include = T, message=F}
...
3. Random Forest
```{r rf, echo = T, include = T, message=F}
#random forest
...
```{r comparison, echo = T, include = T, message=F}
